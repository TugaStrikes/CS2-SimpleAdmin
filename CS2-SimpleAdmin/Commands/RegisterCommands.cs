...
public static class RegisterCommands
{
    ...
    [
        ...
        new CommandMapping("css_swap", CS2_SimpleAdmin.Instance.OnSwapCommand),
        new CommandMapping("css_spec", CS2_SimpleAdmin.Instance.OnSpecCommand),
        ...
        new CommandMapping("css_drespawn", CS2_SimpleAdmin.Instance.OnDRespawnCommand),
    ...
    private static void CreateConfig()
    {
        var commands = new CommandsConfig
        {
            Commands = new Dictionary<string, Command>
            {
                ...
                { "css_drespawn", new Command { Aliases = ["css_drespawn"] } },
